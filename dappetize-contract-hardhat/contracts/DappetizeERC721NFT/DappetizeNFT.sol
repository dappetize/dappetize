    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(
        ...
        __ERC721_init("DappetizeNFT", "DAPPN");
    ...
    function delegatedMint(address to, string memory uri) public whenNotPaused nonReentrant{
        require(msg.sender == _authorizedContract, "Not authorized to mint");
